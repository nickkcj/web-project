  ...
  return (
    <section className="flex flex-col md:flex-row items-center justify-between bg-transparent mb-[60px] w-full">
      <div className="flex-1 md:pr-10 mb-8 md:mb-0 flex flex-col items-start">
        <h1 className="text-white text-[3rem] md:text-[3rem] font-extrabold leading-[1.2] mb-[30px] text-left mt-[30px]">
        ...
        <button 
          className="text-[#14181C] text-[1.5rem] bg-white px-[30px] py-[15px] rounded-[10px] hover:bg-gray-200 transition-colors self-start"
      ...
      <div className="flex-1 flex justify-center md:justify-end w-full">
        <img 
          src={Clapperboard} 
          alt="Clapperboard" 
          className="w-[420px] h-[300px] object-contain rounded-lg max-w-full max-md:w-[320px] max-md:h-[220px]"
        />
      </div>
    </section>
  );
