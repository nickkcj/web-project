...
router.get('/followers/:userId', validateUserIdParam, handleValidationErrors, getFollowersByUserId);
router.get('/following/:userId', validateUserIdParam, handleValidationErrors, getFollowingByUserId);
